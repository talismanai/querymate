...
class Querymate(BaseModel):
    ...
    Attributes:
        q (dict[str, Any] | None): Filter conditions for the query. Default is {}.
        ...
        fields (list[str | dict[str, Any]] | None): Fields to include in the response. Default is all fields.
    ...
    @classmethod
    def querymate_dependency(cls, request: Request) -> "Querymate":
